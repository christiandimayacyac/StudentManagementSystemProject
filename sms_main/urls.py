...
urlpatterns = [
    ...
    path('admin/manage/leaves/', admin_views.ManageStaffLeaves.as_view(), name='manage-staff-leaves'),
    path('admin/leave/process/', admin_views.ApproveRejectStaffLeave.as_view(), name='process-staff-leave'),
