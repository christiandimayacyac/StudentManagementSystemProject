...
urlpatterns = [
    ...
    path('admin/student/ajax/getsubjects/', admin_views.AjaxGetSubjects.as_view(), name='ajax-get-subjects'),
    ...
    path('staff/dashboard/attendance', staff_views.StudentAttendanceView.as_view(), name='view-student-attendance'),
    ...
    path('staff/dashboard/attendance/report/fetch', staff_views.AjaxFetchAttendance.as_view(), name='ajax-staff-fetch-attendance-report'),
    path('staff/dashboard/attendance/students/fetch', staff_views.AjaxFetchStudents.as_view(), name='ajax-staff-fetch-students'),
    path('staff/dashboard/attendance/students/save', staff_views.AjaxSaveAttendance.as_view(), name='ajax-save-student-attendance'),
